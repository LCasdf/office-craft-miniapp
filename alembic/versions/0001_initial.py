...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=False), server_default=sa.text("CURRENT_TIMESTAMP(3)")),
        sa.Column("updated_at", sa.DateTime(timezone=False), server_default=sa.text("CURRENT_TIMESTAMP(3)")),
    ...
    op.create_table(
        ...
        sa.Column("vip_expire_at", sa.DateTime(timezone=False), nullable=True),
        sa.Column("updated_at", sa.DateTime(timezone=False), server_default=sa.text("CURRENT_TIMESTAMP(3)")),
    ...
    op.create_table(
        ...
        sa.Column("timeout_at", sa.DateTime(timezone=False), nullable=True),
        sa.Column("result_expires_at", sa.DateTime(timezone=False), nullable=True),
